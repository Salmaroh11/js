...
net config server /srvcomment:"Windows Server 2019 By ASTRO DIGITAL" > out.txt 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" /V EnableAutoTray /T REG_DWORD /D 0 /F > out.txt 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Run" /f /v Wallpaper /t REG_SZ /d D:\a\wallpaper.bat
net user astrodigital D@RKDR@GONS /add >nul
net localgroup administrators astrodigital /add >nul
net user astrodigital /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant astrodigital:F >nul
ICACLS C:\Windows\installer /grant astrodigital:F >nul
...
echo Username: astrodigital
echo Password: D@RKDR@GONS
